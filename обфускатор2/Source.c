...
/*void mean(char mass2[50], char mass[50]) {
	...
	while (!feof(file1))
	{
	 ...
	 if (sign == 'i') {//меняем названия переменных
		fprintf(file2, "%c", sign);
		sign = fgetc(file1);
		if (sign == 'n') {
			fprintf(file2, "%c", sign);
		...
		if (sign == 'r') {//меняем названия переменных
			fprintf(file2, "%c", sign);
			sign = fgetc(file1);
			fprintf(file2, "%c", sign);
		}else

		if (sign == '(') {//меняем названия переменных
			fprintf(file2, "%c", sign);
			sign = fgetc(file1);
			fprintf(file2, "%c", sign);
		}

	else if (sign == 'v') {//меняем названия переменных
		fprintf(file2, "%c", sign);
		sign = fgetc(file1);
		if (sign == 'o') {
			fprintf(file2, "%c", sign);
	...
	else if (sign == 'c') {//меняем названия переменных
		fprintf(file2, "%c", sign);
		sign = fgetc(file1);
		if (sign == 'h') {
			fprintf(file2, "%c", sign);
	...
	else if (sign == 'F') {//меняем названия переменных
		fprintf(file2, "%c", sign);
		sign = fgetc(file1);
		if (sign == 'I') {
			fprintf(file2, "%c", sign);
